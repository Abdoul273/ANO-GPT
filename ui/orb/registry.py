...
register(OrbSpec(
    id="portrait", label="HUMAIN",
    tagline="Vrai visage photo : regard, paupières et lèvres animés par la voix",
    target="ui.orb.styles.portrait:PortraitOrb", swatch="#d9a07a",
))
register(OrbSpec(
