...
class SystemOpsMixin:
    ...
    def _toggle_style(enabled: bool) -> str:
        ...
        if enabled:
            return f"""
                QPushButton {{
                    background: rgba(0, 255, 136, 0.12); color: {C.GREEN};
                    border: 1px solid {C.GREEN}; border-left: 2px solid {C.GREEN};
                    border-radius: 4px;
