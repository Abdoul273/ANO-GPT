...
from core.tool_agent import AgentToolsMixin
...
from core.tool_deferred import DeferredToolsMixin
from core.tool_declarations import (  # noqa: F401 — ré-exportés
    CONSULT_BRAIN_DECLARATION,
    TOOL_DECLARATIONS,
    _RETIRED_TOOLS,
)
from core import screen_reader, tool_stats, undo_stack
...
class ToolDispatcher(AgentToolsMixin, DeferredToolsMixin):
